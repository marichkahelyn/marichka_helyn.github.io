import { useState, useEffect } from "react"; // Додали useEffect сюди
...
export default function HotTours({ allTours, onBook, bookedIds = [] }) {
  // Ініціалізуємо порожнім масивом
  const [tours, setTours] = useState([]);
  const [activePlace, setActivePlace] = useState(null);

  // Цей блок "чекає", поки allTours оновиться в App.jsx і оновить локальний список
  useEffect(() => {
