    ...
    <Router>
      <div className="main-bg">
        <header className="header">
          ...
          <nav>
            <ul className="nav-links">
              ...
              {user && <li><Link to="/bookings">МОЇ БРОНЮВАННЯ ({booked.length})</Link></li>}
        ...
        <main className="content">
          <Routes>
            <Route path="/" element={<HotTours allTours={tours} onBook={handleBooking} bookedIds={bookedIds} user={user} />} />
            <Route path="/bookings" element={<BookingList bookedTours={booked} />} />
            <Route path="/tour/:id" element={<TourPage user={user} apiUrl={API_URL} />} />
            <Route path="/contacts" element={<ContactPage apiUrl={API_URL} />} />
            <Route path="/auth" element={<AuthPage setUser={setUser} apiUrl={API_URL} />} />
          </Routes>
        </main>
