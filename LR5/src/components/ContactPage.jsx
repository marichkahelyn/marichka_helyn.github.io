...
export default function ContactPage({ apiUrl }) {
      ...
      <div className="contact-glass-box">
        <div className="contact-form-area">
          ...
          <form className="main-form">
            ...
            <button type="button" className="buy-btn" onClick={handleSubmit} disabled={loading}>
              {loading ? 'Надсилання...' : 'ВІДПРАВИТИ ПОВІДОМЛЕННЯ'}
            </button>
          </form>
        </div>
